...
`bryanunitek/UniCORE.OpenBao` is the **OpenBao** family member: On-prem-deployment-shape public gift surface. Documentation today; source code at certification.

**Family purpose:** Open-source secrets management (Vault safe fork) — encryption keys, DB credentials, API tokens for UniCORE.
...
UniCORE.OpenBao is published as a **four-repo family**:

- `bryanunitek/UniCORE.OpenBao` — public on-prem-deployment-shape gift surface ← **this repo**
- `bryanunitek/UniSaaS.UniCORE.OpenBao` — public SaaS-deployment-shape gift surface
- `bryanunitek/UniCORE.OpenBao-Claw` (private) — on-prem-shape working repository
- `bryanunitek/UniSaaS.UniCORE.OpenBao-Claw` (private) — SaaS-shape working repository
...
- **Public discussion:** [GitHub Discussions](https://github.com/bryanunitek/UniCORE.OpenBao/discussions)
